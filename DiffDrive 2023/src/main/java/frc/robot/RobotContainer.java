...
public class RobotContainer { 
  ...
  public Command ramAutoBuilder(String pathName, HashMap<String, Command> eventMap) {
    ...
    RamseteAutoBuilder pathBuilder = new RamseteAutoBuilder(
        ...
        new RamseteController(Constants.DiffDriveConstants.AutoConstants.kRamseteB, Constants.DiffDriveConstants.AutoConstants.kRamseteZeta),
        Constants.DiffDriveConstants.AutoConstants.kDriveKinematics,
        new SimpleMotorFeedforward(
            Constants.DiffDriveConstants.AutoConstants.ksVolts,
            Constants.DiffDriveConstants.AutoConstants.kvVoltSecondsPerMeter,
            Constants.DiffDriveConstants.AutoConstants.kaVoltSecondsSquaredPerMeter),
        drive::getWheelSpeeds,
        new PIDConstants(Constants.DiffDriveConstants.AutoConstants.kPDriveVel, 0, 0),
        drive::setVolts,
        eventMap,
        true,
        drive);
