...
public class Drivetrain extends SubsystemBase {
  ...
  public double getLeftPositionMeters() {
    return inputs.leftEncoderPos * Units.inchesToMeters(Constants.DiffDriveConstants.AutoConstants.kWheelRadiusInches);
  }

  public double getRightPositionMeters() {
    return inputs.rightEncoderPos * Units.inchesToMeters(Constants.DiffDriveConstants.AutoConstants.kWheelRadiusInches);
  }

  public double getLeftVelocityMeters() {
    return inputs.leftEncoderVelc * Units.inchesToMeters(Constants.DiffDriveConstants.AutoConstants.kWheelRadiusInches);
  }

  public double getRightVelocityMeters() {
    return inputs.rightEncoderVelc * Units.inchesToMeters(Constants.DiffDriveConstants.AutoConstants.kWheelRadiusInches);
  }
}
